...
class GigasecondTest < Minitest::Test
  ...
  def test_with_your_birthday
    gs = Gigasecond.from(Time.utc(1979, 7, 14, 0, 0, 0))
    assert_equal Time.utc(2011, 3, 22, 1, 46, 40), gs
  end

  def test_with_your_birthday
    gs = Gigasecond.from(Time.utc(2003, 12, 30, 3, 0, 0))
    assert_equal Time.utc(2035, 9, 7, 4, 46, 40), gs
  end
